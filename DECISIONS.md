...
- Vital-sign `sanity` bounds are copied renderer validation envelopes, not authored plausibility bounds; the `temp` ceiling is sourced and ratified (2026-07-15, see §7), the remaining six bounds stay open pending their deterministic inventory.
