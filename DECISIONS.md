...
Live constants (verify against `scripts/audit/non-mcq-bias-lib.ts`, not here): `audit_version 2.1.0`, `sata_count_min_n: 8`, `sata_count_degeneracy: 0.70`, `template_repeat_max_share: 0.15`. The ordered-response minimum is derived from the share limit, not stored.
