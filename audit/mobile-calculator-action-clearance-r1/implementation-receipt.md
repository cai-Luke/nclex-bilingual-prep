...
- The final evidence tip is the commit containing this receipt, reported in the final handoff and obtainable with `git log -1 --format=%H -- audit/mobile-calculator-action-clearance-r1/implementation-receipt.md`. Its hash is intentionally not embedded in itself.
