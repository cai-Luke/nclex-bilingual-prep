...
const BATCH_FILE = path.join(process.cwd(), "audit/terminal-sentence-semantic-census-2026-07-21/batches/batch-002.jsonl");
...
out.end();
console.log(`Extracted ${extracted} unreviewed rows to batch-002.jsonl.`);
