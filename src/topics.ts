...
// Canonical vocabulary for bundled banks.
...
export const TOPIC_ALIAS_ENTRIES = [
  ...
  ["colostomy discharge teaching for limited english proficiency", "Discharge Planning & Handoff"],
  ...
  ["adult immunization", "Adult Health & Wellness"],
  ["acute decompensated heart failure", "Cardiovascular Disorders"],
  ["acute kidney injury", "Renal & Gastrointestinal Disorders"],
  ["acute kidney injury fluid response", "Renal & Gastrointestinal Disorders"],
  ["acute pancreatitis complications", "Renal & Gastrointestinal Disorders"],
  ["adhf pathophysiology", "Cardiovascular Disorders"],
  ["atrial arrhythmias", "Cardiovascular Disorders"],
  ["atrial flutter", "Cardiovascular Disorders"],
  ["av heart blocks", "Cardiovascular Disorders"],
  ["bowel preparation fluid deficit", "Nutritional & Fluid Support"],
  ["blood transfusion reaction (hemolytic/trali)", "Procedural Complications & Dialysis"],
  ["car-t cytokine release syndrome and icans monitoring", "Sepsis & Septic Shock"],
  ["caregiver burden and family adaptation", "Mental Health Disorders"],
  ["caregiver strain", "Mental Health Disorders"],
  ["chronic illness adaptation", "Mental Health Disorders"],
  ["chronic illness self-management", "Chronic Disease Management & Lifestyle"],
  ["chronic illness self-management and health literacy", "Chronic Disease Management & Lifestyle"],
  ["chronic illness self-management follow-up", "Chronic Disease Management & Lifestyle"],
  ["chronic illness self-management foot inspection", "Chronic Disease Management & Lifestyle"],
  ["chronic illness self-management goals", "Chronic Disease Management & Lifestyle"],
  ["chronic illness self-management with symptom tracking", "Chronic Disease Management & Lifestyle"],
  ["compartment syndrome after extremity injury", "Procedural Complications & Dialysis"],
  ["creatinine trend calculation in aki", "Renal & Gastrointestinal Disorders"],
  ["decompensated shock", "Cardiovascular Disorders"],
  ["dehydration fluid deficit cues", "Nutritional & Fluid Support"],
  ["delirium discharge readiness", "Discharge Planning & Handoff"],
  ["diabetes foot care self-management", "Chronic Disease Management & Lifestyle"],
  ["diabetes self-management planning", "Chronic Disease Management & Lifestyle"],
  ["disseminated intravascular coagulation (dic)", "Laboratory & Diagnostic Tests"],
  ["endotracheal intubation", "Procedural Complications & Dialysis"],
  ["enteral pump duration calculation", "Nutritional & Fluid Support"],
  ["anesthesia equipment", "Patient & Environment Safety"],
  ["first-degree av block", "Cardiovascular Disorders"],
  ["generating solutions for caregiver respite and community resources", "Mental Health Disorders"],
  ["fluid balance monitoring", "Nutritional & Fluid Support"],
  ["health literacy and medication adherence", "Medication Safety & Admin"],
  ["health literacy discharge teaching", "Chronic Disease Management & Lifestyle"],
  ["hemolytic reaction confirmation", "Procedural Complications & Dialysis"],
  ["home health wound-care teaching with teach-back failure", "Discharge Planning & Handoff"],
  ["home skin inspection for pressure injury prevention", "Elimination & Comfort"],
  ["intake and output net balance", "Nutritional & Fluid Support"],
  ["intake and output output total", "Nutritional & Fluid Support"],
  ["intake and output total verification", "Nutritional & Fluid Support"],
  ["interpreter-supported discharge teaching", "Discharge Planning & Handoff"],
  ["infusion pump time verification", "Dosage Calculations"],
  ["injection route recognition from skin cross-section", "Medication Safety & Admin"],
  ["injection visual cue interpretation", "Medication Safety & Admin"],
  ["lithium toxicity", "Psychotropic Medications"],
  ["medication label dose verification", "Medication Safety & Admin"],
  ["moisture management for pressure injury prevention", "Elimination & Comfort"],
  ["needlestick exposure response", "Standard Precautions & Hygiene"],
  ["pacemaker discharge teaching", "Cardiovascular Disorders"],
  ["pressure injury prevention in rehabilitation", "Elimination & Comfort"],
  ["pressure injury staging", "Elimination & Comfort"],
  ["pressure injury staging and evaluation of wound healing", "Elimination & Comfort"],
  ["pressure injury wound area trend", "Elimination & Comfort"],
  ["patient-controlled analgesia dose limits", "Medication Safety & Admin"],
  ["pulmonary edema interventions", "Cardiovascular Disorders"],
  ["renal laboratory response to fluid therapy", "Renal & Gastrointestinal Disorders"],
  ["second-degree av block mobitz i", "Cardiovascular Disorders"],
  ["second-degree av block mobitz ii", "Cardiovascular Disorders"],
  ["smoking cessation", "Chronic Disease Management & Lifestyle"],
  ["self-management goal setting", "Chronic Disease Management & Lifestyle"],
  ["target layer identification from visual", "Medication Safety & Admin"],
  ["teach-back for health literacy", "Chronic Disease Management & Lifestyle"],
  ["teach-back for medication safety", "Medication Safety & Admin"],
  ["third-degree av block", "Cardiovascular Disorders"],
  ["transfusion reaction priority", "Procedural Complications & Dialysis"],
  ["transfusion reaction protocol", "Procedural Complications & Dialysis"],
  ["tumor lysis syndrome", "Electrolyte Imbalances"],
  ["visual technique analysis", "Medication Safety & Admin"],
