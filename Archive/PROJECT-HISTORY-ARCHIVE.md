# Project History — Archive (frozen snapshot, 2026-06-26)

> **This is an archived snapshot, not the live status record.** The current status map lives in [`PROJECT-HISTORY.md`](../PROJECT-HISTORY.md). This file is retained for the **milestone history dated 2026-06-23 and earlier** (the bulk of the `## Milestones` section below). The current-status, schema, and 2026-06-24+ milestone sections near the top are a frozen copy as of the split and may be stale — do not treat them as authoritative. Nothing reads this file as part of the agent read-order.
...
- Wrote connector and operational handoffs: `Archive/root-cleanup-2026-06-26/GPT-RAW-BANK-MCP-HANDOFF-2026-06-23.md` and `Archive/root-cleanup-2026-06-26/CLAUDE-FSMCP-DEFERRED-HANDOFF-2026-06-23.md`.
...
- Dry-run outcome after review corrections: 171 proposed rows, 65 carried-forward rows, 0 vocabulary-gap flags, and 1 deliberately unresolved row; 66 proposals are `category_and_topic` and require the harder approval review.
