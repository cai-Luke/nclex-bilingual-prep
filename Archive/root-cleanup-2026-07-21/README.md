...
- `GPT-SCORED-FORMAT-CONSTRUCT-AUDIT-SPEC-2026-07-21.md` — completed audit commission. Its findings,
  owner ruling, bank implementation, and verification are recorded under
  `audit/scored-format-construct-audit-2026-07-21/` and
  `audit/july16-coverage-construct-audit-2026-07-21/`.
- `GEMINI-TERMINAL-SENTENCE-SEMANTIC-CENSUS-SPEC-2026-07-21.md` — superseded after the commissioned
  execution was rejected as noncompliant. The clean queue and forensic record remain under
  `audit/terminal-sentence-semantic-census-2026-07-21/`; the active semantic-review route is the
  Sonnet work order retained at repository root.
