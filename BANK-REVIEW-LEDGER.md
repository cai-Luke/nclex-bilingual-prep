...
| `banks/gap-fill-50.json` | Antigravity (written to fill coverage gaps) | 50 | 2026-06-05: valid | 2026-06-05: fully validated and clinical concepts aligned with NCLEX-RN requirements | `fixed-and-validated` | 50 standalone questions generated based on census gaps to target Management of Care, Basic Care and Comfort, Safety and Infection Control, and Pharmacological/Parenteral Therapies. Uses unique namespace `gap_50_*`. |
...
| `banks/banks-raw/claude-2026-06-05-gapfill-moc-pharm.json` | Claude | 6 | 2026-06-06: valid (`npm run validate-bank`) | 2026-06-06 Codex source-checked review: 5 pass, 1 discard-for-redundancy | `content-reviewed` | Census-driven gap-fill targeting Management of Care and Pharmacological/Parenteral Therapies. Audit report: `audit/claude-2026-06-05-gapfill-moc-pharm.report.md`. Five items are eligible for promotion if desired: `claude_jun05_moc_case_mgmt_01`, `claude_jun05_moc_referral_slp_02`, `claude_jun05_moc_quality_improvement_03`, `claude_jun05_pharm_pca_opioid_safety_04`, and `claude_jun05_pharm_clozapine_teaching_05`. Discard `claude_jun05_pharm_insulin_mixing_06`; it is clinically correct but redundant with bundled `gemini_d2_insulin_01`. |
